...
%   De N f�rste i C er bladene, de andre er noder med to andre noder (blad)
%   under seg, men en trenger ikke n�yaktig hvordan treet er under hver node
...
%   siden en kun har "last" tr�r. (for hver gang hovedl�kka kj�rer
%   samles to tr�r til et tre, alle blad som h�rer til hvert av disse
%   tr�rne f�r kodeordeslengden, HL, �ket med en, og en m� oppdatere hvilken
...
[~,Si]=sort(-Sp);       % Si is indexes for descending symbols
